    ...
    <section ref={containerRef} id="arak" className="relative py-24 overflow-hidden">
      ...
      <div ref={ref} className="section-container relative z-10">
        ...
        <div className="max-w-5xl mx-auto">
          ...
          >
            <div className="inline-flex items-center gap-3 px-6 py-3 bg-white/80 backdrop-blur-sm rounded-full border border-petrol-100 shadow-sm">
              <svg className="w-5 h-5 text-teal-500" fill="currentColor" viewBox="0 0 20 20">
                <path fillRule="evenodd" d="M2.166 4.999A11.954 11.954 0 0010 1.944 11.954 11.954 0 0017.834 5c.11.65.166 1.32.166 2.001 0 5.225-3.34 9.67-8 11.317C5.34 16.67 2 12.225 2 7c0-.682.057-1.35.166-2.001zm11.541 3.708a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
              </svg>
              <span className="text-petrol-600">Biztonságos fizetés</span>
            </div>
          </motion.div>
        </div>
      </div>
